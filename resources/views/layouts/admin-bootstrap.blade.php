    ...
    <div class="container-fluid">
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                ...
                <li class="nav-item"> 
                    <a class="nav-link d-flex align-items-center gap-2" href="/admin/orders"> <svg class="bi" aria-hidden="true">
                    <use xlink:href="#file-earmark"></use></svg>Orders</a> 
                </li>
                <li class="nav-item"> 
                    <a class="nav-link d-flex align-items-center gap-2" href="/admin/brands"> <svg class="bi" aria-hidden="true">
                    <use xlink:href="#file-earmark"></use></svg>Brands</a> 
                </li>
                <li class="nav-item"> 
                    <a class="nav-link d-flex align-items-center gap-2" href="/admin/categories"> <svg class="bi" aria-hidden="true">
                    <use xlink:href="#file-earmark"></use></svg>Categories</a> 
                </li>
                            ...
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2" href="/admin/users"> <svg
                                        class="bi" aria-hidden="true">
